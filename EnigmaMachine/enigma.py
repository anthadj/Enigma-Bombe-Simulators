...
#The values of the plugboard, up to ten pairs. These were generated randomly using the function enigmaGenerateRandomVals. These were changed every day, but for simplicity we will use these for now
